    ...
    <div className="glass-card rounded-2xl p-6 bg-white/60 border border-white/60 backdrop-blur-xl h-full flex flex-col">
      ...
      >
        ...
        {activities.map((activity) => (
          ...
          >
            <div
              className={`flex-shrink-0 w-10 h-10 rounded-full flex items-center justify-center ${colorClasses[activity.color]} ring-4 ring-white shadow-sm z-10 group-hover:scale-110 transition-transform duration-200`}
            >
