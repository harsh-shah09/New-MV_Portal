          ...
          return (
            <div
              ...
              <div className="mt-4 grid grid-cols-2 gap-x-4 gap-y-3 text-sm">
                ...
                <div>
                  <div className="text-gray-500 text-xs tracking-widest">INTERNAL SERIAL</div>
                  <div className="font-medium text-gray-800 mt-0.5">{asset.Internal_Serial_Number__c || '-'}</div>
                </div>
